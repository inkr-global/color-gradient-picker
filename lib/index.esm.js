...
var AlphaSlider = function (props) {
    ...
    // ------------------------------------------------------------------------------------------
    var _a = useState(false), isInteracting = _a[0], setIsInteracting = _a[1];
    var sliderDivRef = useRef(null);
    // ------------------------------------------------------------------------------------------
    var updateAlpha = useCallback(function (evt) {
    ...
    return (jsxs("div", __assign({ className: cn(s$c.alpha_slider, className), ref: sliderDivRef, title: "Alpha" }, interactionCallbacks, { children: [jsx("div", { className: s$c.alpha_slider_bg, style: alphaStyle }), jsx("div", { className: cn(s$c.alpha_slider_picker), style: sliderStyle })] })));
};

var EyeDropper$1 = function (_a) {
    var onClick = _a.onClick;
    return (jsx("button", __assign({ style: {
            outline: "none",
            border: "none",
...
var HueSlider = function (props) {
    ...
    return (jsx("div", __assign({ className: cn(s$b.hue_slider, className), ref: sliderDivRef, title: "Hue" }, interactionCallbacks, { children: jsx("div", { className: cn(s$b.hue_slider_picker), style: sliderStyle }) })));
};
...
function InputAlphaInfo() {
    return jsx("div", { className: s$a.alpha_info });
}
var ALPHA_SYMBOL = "%";
...
function Alpha(props) {
    ...
    var _a = useState(getAlphaString(value)), valueState = _a[0], setValueState = _a[1];
    // -----------------------------------------------------------------------
    useEffect(function () {
...
function Degree(props) {
    ...
    // -----------------------------------------------------------------------
    return (jsx(Input, __assign({}, rest, { onChange: _onInternalChange, onKeyDown: _onKeyDown, value: valueState, onInputBlur: _onBlur, info: jsx(DegreeInfo, {}), inputWidth: 35 })));
}
...
function GradientInput(props) {
    ...
    // -----------------------------------------------------------------------
    return (jsx(Input, __assign({}, rest, { value: "Gradient", onChange: noop, info: jsx(GradientPreview, { value: value }) })));
}
...
function Hex(props) {
    ...
    // -----------------------------------------------------------------------
    return (jsx(Input, __assign({}, rest, { onChange: _onInternalChange, onKeyDown: _onKeyDown, onInputBlur: _onBlur, value: valueState.toUpperCase(), info: jsx(ColorPreview, { value: value }) })));
}
...
function InputTextInfo(props) {
    ...
    return jsx("div", __assign({ className: s$6.input_text }, { children: children }));
}
// ------------------------------------------------------------------------------------------
function Rgb(props) {
    ...
    // -----------------------------------------------------------------------
    return (jsx(Input, __assign({}, rest, { onChange: _onInternalChange, onKeyDown: _onKeyDown, value: valueState, onInputBlur: _onBlur, info: jsx(InputTextInfo, { children: info }), inputProps: customInputProps })));
}
...
function Input(props) {
    ...
    // -----------------------------------------------------------------------
    var _b = useState(), isFocus = _b[0], setFocus = _b[1];
    ...
    // -----------------------------------------------------------------------
    return (jsxs("div", __assign({ className: cn(s$7.container, className), style: style }, { children: [label && jsx("div", __assign({ className: cn(s$7.label) }, { children: label })), jsxs("div", __assign({ className: cn(s$7.wrapper, isFocus && s$7.isFocus, isExtraComponent && s$7.extra_component, inputWrapperClassName), ref: containerRef }, { children: [info && !isExtraComponent && (jsx("div", __assign({ className: cn(s$7.info) }, { children: info }))), jsx("input", __assign({}, restInputProps, { style: __assign(__assign({}, inputStyle), { width: inputWidth }), onFocus: function (e) {
...
var InputFields = function (props) {
    ...
    return (jsxs("div", __assign({ className: s$5.color_inputs_wrapper }, { children: [jsx(Input.Hex, { label: "HEX", inputWidth: 100, style: { gridArea: "hex" }, value: hex, onChange: function (_hex) {
                    setColor(_hex, hexToHsv(_hex));
                } }), jsx(Input.Alpha, { inputWidth: 40, style: { gridArea: "alpha" }, value: alpha, onChange: function (_alpha) {
                    setAlpha(_alpha);
                } }), jsx(Input.Rgb, { label: "RGB", info: "R", inputWidth: 26, style: {
                    gridArea: "red",
                    marginLeft: -2,
                ...
                } }), jsx(Input.Rgb, { info: "G", inputWidth: 26, style: { gridArea: "green" }, value: green, onChange: function (_green) {
                    setColorFromRgb({
                        red: red,
                        green: _green,
                        blue: blue,
                    });
                } }), jsx(Input.Rgb, { info: "B", inputWidth: 26, style: { gridArea: "blue" }, value: blue, onChange: function (_blue) {
                    setColorFromRgb({
                        red: red,
                        green: green,
                        blue: _blue,
...
var SaturationPicker = function (props) {
    ...
    return (jsx("div", __assign({ className: cn(s$4.saturation_value_selector), style: {
            backgroundColor: hueColor,
        }, ref: selectorDivRef, title: "Saturation and Value" }, interactionCallbacks, { children: jsx("div", { className: cn(s$4.saturation_value_picker), style: {
...
var ColorPicker = function (props) {
    ...
    var _a = useState(hex), setHexState = _a[1];
    // ------------------------------------------------------------------------------------------
    var hsvRef = useRef(hexToHsv(hex));
    ...
    return (jsxs(Fragment, { children: [jsx(SaturationPicker, { hue: hue, saturation: saturation, value: value, onChange: function (_saturationValue) {
                    _onSetColorFromHsv(__assign(__assign({}, hsvRef.current), _saturationValue));
                } }), jsxs("div", __assign({ className: cn(s$d.sliders_wrapper) }, { children: [jsx(EyeDropper$1, { onClick: _onEyeDropperClick }), jsxs("div", __assign({ className: cn(s$d.sliders) }, { children: [jsx(HueSlider, { hue: hue, onChange: function (updatedHue) {
                                    return _onSetColorFromHsv(__assign(__assign({}, hsvRef.current), { hue: updatedHue }));
                                }, className: s$d.hue_slider }), jsx(AlphaSlider, { alpha: alpha, hex: hex, onChange: onAlphaChange })] }))] })), jsx(InputFields, { hex: hex, rgb: rgb, alpha: alpha, setAlpha: onAlphaChange, setColor: _onSetColor, setColorFromRgb: _onSetColorFromRgb })] }));
};
...
var useStopDragging = function (_a) {
    ...
    var _b = useState(0), posStart = _b[0], setPosStart = _b[1];
...
var ColorStop = function (props) {
    ...
    return (jsx("div", { className: cn(s$2.cs, isActive && s$2.active), ref: colorStopRef, style: {
            left: offset,
...
var ColorStopsHolder = function (props) {
    ...
    return (jsx("div", __assign({ style: {
            ...
            height: 22,
            position: "relative",
        } }, { children: stops.map(function (stop) { return (jsx(ColorStop, __assign({ stop: stop }, rest), stop.id)); }) })));
};
...
var GradientPicker = function (props) {
    ...
    var _d = useState(defaultActiveColor.id), activeColorId = _d[0], setActiveColorId = _d[1];
    // ------------------------------------------------------------------------------------------
    var limits = useMemo(function () {
    ...
    // ------------------------------------------------------------------------------------------
    return (jsxs(Fragment, { children: [jsxs("div", __assign({ className: s$1.gp_wrap }, { children: [jsx(Input.Degree, { onChange: handleDegreeChange, value: degree }), jsxs("div", { children: [jsx(Palette, { onAddColor: handleColorAdd, degree: degree, palette: palette, disabled: stopsHolderDisabled }), jsx(ColorStopsHolder, { stops: mapPaletteToStops({
                                    palette: palette,
                                    activeId: activeColorId,
                                }), limits: limits, onPosChange: handleStopPosChange, onDeleteColor: handleColorDelete, onDragStart: onStopDragStart, onDragEnd: noop })] })] })), jsx(ColorPicker, { hex: rgbToHex(red, green, blue), alpha: alpha, onAlphaChange: handleStopAlphaChange, onColorChange: handleStopColorChange })] }));
};
...
var UserInput = function (props) {
    ...
    var alphaInput = hasAlphaInput ? (jsxs(Fragment, { children: [jsx("div", { className: s.input_vertical_divider }), jsx(Input.Alpha, __assign({}, rest, { isExtraComponent: true, value: alpha, onChange: onAlphaChange, inputWidth: 45 }))] })) : undefined;
    return (jsxs(Fragment, { children: [type === COLOR_TYPE.SOLID && (jsx(Input.Hex, __assign({}, rest, { inputWidth: inputWidth, value: solid, onChange: onSolidColorChange, extraInput: alphaInput }))), type === COLOR_TYPE.LINEAR && (jsx(Input.Gradient, __assign({}, rest, { inputWidth: inputWidth, value: gradient })))] }));
};
...
function ColorGradientPicker(props) {
    ...
    // ------------------------------------------------------------------------------------------
    var _b = useState(false), isOpenPicker = _b[0], setOpenPicker = _b[1];
    var containerRef = useRef(null);
    // ------------------------------------------------------------------------------------------
    ...
    var onHidePicker = useCallback(function () {
        setOpenPicker(false);
    }, []);
    // ------------------------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------------------------
    return (jsxs("div", __assign({ ref: containerRef, className: cn(s$e.wrapper, classNamePrefix, className) }, { children: [jsx(UserInput, __assign({}, rest, { onSolidColorChange: handleSolidColorChange, onAlphaChange: handleTotalAlphaChange, color: color, onInputFocus: handleInputFocus })), isOpenPicker && (jsxs("div", __assign({ className: s$e.picking_panel }, { children: [jsx(ColorTypeSelect, { value: propColorType, onChange: handleSetColorType }), propColorType === COLOR_TYPE.LINEAR && (jsx(GradientPicker, { gradient: linearGradient, onLinearGradientChange: handleLinearGradientChange })), propColorType === COLOR_TYPE.SOLID && (jsx(ColorPicker, { hex: solidColor, alpha: totalAlpha, onAlphaChange: handleTotalAlphaChange, onColorChange: handleSolidColorChange }))] })))] })));
}

export { ColorGradientPicker, ColorPicker, GradientPicker, ColorGradientPicker as default };
