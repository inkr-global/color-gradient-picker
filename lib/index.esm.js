...
const AlphaSlider = (props) => {
    ...
    // ------------------------------------------------------------------------------------------
    const updateAlpha = useCallback((evt) => {
    ...
    return (jsxs("div", { className: cn(s$c.alpha_slider, className), ref: sliderDivRef, title: "Alpha", ...interactionCallbacks, children: [jsx("div", { className: s$c.alpha_slider_bg, style: alphaStyle }), jsx("div", { className: cn(s$c.alpha_slider_picker), style: sliderStyle })] }));
};
...
const HueSlider = (props) => {
    ...
    return (jsx("div", { className: cn(s$b.hue_slider, className), ref: sliderDivRef, title: "Hue", ...interactionCallbacks, children: jsx("div", { className: cn(s$b.hue_slider_picker), style: sliderStyle }) }));
};
...
function Alpha(props) {
    ...
    const [valueState, setValueState] = useState(getAlphaString(value));
    // -----------------------------------------------------------------------
    useEffect(() => {
    ...
    // -----------------------------------------------------------------------
    return (jsx(Input, { ...rest, info: jsx(InputAlphaInfo, {}), onChange: _onInternalChange, onKeyDown: _onKeyDown, onInputBlur: _onBlur, value: valueState, inputClassName: s$a.alpha_input }));
}

const DEGREE_SYMBOL = "°";
function DegreeInfo() {
    return (jsx("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", xmlns: "http://www.w3.org/2000/svg", style: {
            position: "relative",
            top: 2,
...
function Degree(props) {
    const { value, onChange, onInputBlur, ...rest } = props;
    const [valueState, setValueState] = useState(getDegreeString(value));
    // ------------------------------------------------------------------------------------------
    useEffect(() => {
    ...
    // -----------------------------------------------------------------------
    return (jsx(Input, { ...rest, onChange: _onInternalChange, onKeyDown: _onKeyDown, value: valueState, onInputBlur: _onBlur, info: jsx(DegreeInfo, {}), inputWidth: 35 }));
}
...
function GradientInput(props) {
    ...
    // -----------------------------------------------------------------------
    return (jsx(Input, { ...rest, value: "Gradient", onChange: noop, info: jsx(GradientPreview, { value: value }) }));
}
...
function Hex(props) {
    ...
    // -----------------------------------------------------------------------
    return (jsx(Input, { ...rest, onChange: _onInternalChange, onKeyDown: _onKeyDown, onInputBlur: _onBlur, value: valueState.toUpperCase(), info: jsx(ColorPreview, { value: value }) }));
}
...
function InputTextInfo(props) {
    ...
    return jsx("div", { className: s$6.input_text, children: children });
}
// ------------------------------------------------------------------------------------------
function Rgb(props) {
    ...
    // -----------------------------------------------------------------------
    return (jsx(Input, { ...rest, onChange: _onInternalChange, onKeyDown: _onKeyDown, value: valueState, onInputBlur: _onBlur, info: jsx(InputTextInfo, { children: info }), inputProps: customInputProps }));
}
...
function Input(props) {
    ...
    // -----------------------------------------------------------------------
    return (jsxs("div", { className: cn(s$7.container, className), style: style, children: [label && jsx("div", { className: cn(s$7.label), children: label }), jsxs("div", { className: cn(s$7.wrapper, isFocus && s$7.isFocus, isExtraComponent && s$7.extra_component, inputWrapperClassName), ref: containerRef, children: [info && !isExtraComponent && (jsx("div", { className: cn(s$7.info), children: info })), jsx("input", { ...restInputProps, style: {
                            ...inputStyle,
                            width: inputWidth,
                        }, onFocus: (e) => {
...
const InputFields = (props) => {
    ...
    return (jsxs("div", { className: s$5.color_inputs_wrapper, children: [jsx(Input.Hex, { label: "HEX", inputWidth: 100, style: { gridArea: "hex" }, value: hex, onChange: (_hex) => {
                    setColor(_hex, hexToHsv(_hex));
                } }), jsx(Input.Alpha, { inputWidth: 40, style: { gridArea: "alpha" }, value: alpha, onChange: (_alpha) => {
                    setAlpha(_alpha);
                ...
                } }), jsx(Input.Rgb, { info: "G", inputWidth: 26, style: { gridArea: "green" }, value: green, onChange: (_green) => {
                    setColorFromRgb({
                        red,
                        green: _green,
                        blue,
                    });
                } }), jsx(Input.Rgb, { info: "B", inputWidth: 26, style: { gridArea: "blue" }, value: blue, onChange: (_blue) => {
                    setColorFromRgb({
                        red,
                        green,
                        blue: _blue,
...
const SaturationPicker = (props) => {
    ...
    // ------------------------------------------------------------------------------------------
    const [isInteracting, setIsInteracting] = useState(false);
    const selectorDivRef = useRef(null);
    const hueColor = hsvToHex(hue, 1, 1);
    ...
    return (jsx("div", { className: cn(s$4.saturation_value_selector), style: {
            backgroundColor: hueColor,
...
const ColorPicker = (props) => {
    ...
    const [, setHexState] = useState(hex);
    // ------------------------------------------------------------------------------------------
    ...
    return (jsxs(Fragment, { children: [jsx(SaturationPicker, { hue: hue, saturation: saturation, value: value, onChange: (_saturationValue) => {
                    _onSetColorFromHsv({
                        ...hsvRef.current,
                        ..._saturationValue,
                    });
                } }), jsxs("div", { className: cn(s$d.sliders_wrapper), children: [jsx(EyeDropper$1, { onClick: _onEyeDropperClick }), jsxs("div", { className: cn(s$d.sliders), children: [jsx(HueSlider, { hue: hue, onChange: (updatedHue) => _onSetColorFromHsv({
                                    ...hsvRef.current,
                                    hue: updatedHue,
...
const ColorStop = (props) => {
    ...
    const colorStopRef = useRef(null);
...
const ColorStopsHolder = (props) => {
    ...
    return (jsx("div", { style: {
            ...
            height: 22,
            position: "relative",
        }, children: stops.map((stop) => (jsx(ColorStop, { stop: stop, ...rest }, stop.id))) }));
};
...
const GradientPicker = (props) => {
    ...
    // ------------------------------------------------------------------------------------------
    return (jsxs(Fragment, { children: [jsxs("div", { className: s$1.gp_wrap, children: [jsx(Input.Degree, { onChange: handleDegreeChange, value: degree }), jsxs("div", { children: [jsx(Palette, { onAddColor: handleColorAdd, degree: degree, palette: palette, disabled: stopsHolderDisabled }), jsx(ColorStopsHolder, { stops: mapPaletteToStops({
                                    palette,
...
const UserInput = (props) => {
    ...
    const alphaInput = hasAlphaInput ? (jsxs(Fragment, { children: [jsx("div", { className: s.input_vertical_divider }), jsx(Input.Alpha, { ...rest, isExtraComponent: true, value: alpha, onChange: onAlphaChange, inputWidth: 45 })] })) : undefined;
    return (jsxs(Fragment, { children: [type === COLOR_TYPE.SOLID && (jsx(Input.Hex, { ...rest, inputWidth: inputWidth, value: solid, onChange: onSolidColorChange, extraInput: alphaInput })), type === COLOR_TYPE.LINEAR && (jsx(Input.Gradient, { ...rest, inputWidth: inputWidth, value: gradient }))] }));
};
